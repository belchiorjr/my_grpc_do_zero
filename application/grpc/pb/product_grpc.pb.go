...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductResult, error) {
	...
	err := c.cc.Invoke(ctx, "/my_grpc_do_zero.ProductService/CreateProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) List(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ProductService_ListClient, error) {
	stream, err := c.cc.NewStream(ctx, &ProductService_ServiceDesc.Streams[0], "/my_grpc_do_zero.ProductService/List", opts...)
	if err != nil {
		return nil, err
	}
...
func _ProductService_CreateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/my_grpc_do_zero.ProductService/CreateProduct",
	}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "my_grpc_do_zero.ProductService",
